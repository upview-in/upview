                                        ...
                                        <tr>
                                            <td class="hero-bg">
                                                <table cellspacing="0" cellpadding="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="font-size:24px; text-align:center; padding: 0 75px; color:#ffffff;">Please verify your account</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                                <div style="line-height: 24px;">
                                                                    Hi {{ appUser()->name }}. Before you start using Upview, you need to verify your account. When asked for the OTP, enter <strong>{{ $otp }}</strong>.<br><br> Sincerely,<br> <a href="{{ route('main.index') }}" target="_blank">Upview</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
