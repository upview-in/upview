        ...
        <div id="active-sticky" class="header-bottom">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col">
                        <a href={{ route("index-main") }} class="brand-logo">
                ...
                <div class="col-12 mb-7">
                    <div class="service-details">
                        <div class="service-details-list">
                            ...
                            <p>
                                Upview.in respects your right to privacy. This privacy policy (“Privacy Policy”) explains who we are, how we collect, share and use information about you and how you can exercise your privacy rights. Our Privacy Policy applies to all users of Upview Social
                                websites and services, including but not limited to www.upview.in (depending on your use, the “Site” and/or the “Service”). For further information on the terms which govern your use of the respective Service, please see
                                https://upview.in/privacy-policy or any service order you may have signed with us.
                            ...
                            <p>
                                ...
                                use of the Service, including for troubleshooting and product improvement purposes; Provide customer support; Communicate and provide additional information that may be of interest to users through email or other means,
                            ...
                            <h4 class="title">8.Legal basis for processing personal data (EEA or UK visitors / users only) </h4>
                            <p>
                            ...
                            <h4 class="title">9. Cookies, similar tracking technology, and analytics </h4>
                            <p>
                            ...
                            <h4 class="title">10. Social Media and Technology Integrations </h4>
                            <p>
                            ...
                            <h4 class="title">14. CAN-SPAM Compliance Notice (U.S. users only) </h4>
                            <p>
                            ...
                            <h4 class="title">16. Transfers Outside of the EEA and Switzerland </h4>
                            <p>
                            ...
                            <h4 class="title">17. Contacting Us, Complaints and Dispute Resolution </h4>
                            <p>
                            ...
                            <h4 class="title">23. Additional Disclosures for California Residents </h4>
                            <p>
                ...
                <div class="row">
                    <div class="col-12">
                        <p>
                            ...
                            <a href="https://upview.in/">Upview.in</a> All Rights Reserved
                        </p>
                    </div>
                </div>
            </div>
