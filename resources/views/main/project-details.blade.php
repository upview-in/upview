...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="project-details__img">
                            <img src="{{ asset('main/images/resources/project-details-img.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                            <div class="project-details__content-left">
                                <h3 class="project-details__content-title">Filmor Experience</h3>
                                <p class="project-details__content-text-1">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.</p>
                                <p class="project-details__content-text-2">Tincidunt elit magnis nulla facilisis sagittis sapien nunc Many desktop publishing packages and web page editors amet ultrices dolores sit ipsum velit purus aliquet massa fringilla leo orci. Sapien nunc amet ultrices.</p>
                                ...
                                <div class="project-details__details-box">
                                    <div class="project-details__details-info">
                                        ...
                                        <div class="project-details__details-info-single">
                                            ...
                                            <p class="project-details__details-info-name">Web & Application Design</p>
                                        </div>
                                        <div class="project-details__details-info-single">
                                            <h5 class="project-details__details-info-client">Date:</h5>
                                            <p class="project-details__details-info-name">20 August, 2021</p>
                                        </div>
                                    </div>
                                    <div class="project-details__details-social-list">
                                        <a href="project-details.html#"><i class="fab fa-twitter"></i></a>
                                        <a href="project-details.html#"><i class="fab fa-facebook"></i></a>
                                        <a href="project-details.html#"><i class="fab fa-pinterest-p"></i></a>
                    ...
                    <div class="col-xl-12">
                        <div class="project-details__pagination-box">
                            <ul class="project-details__pagination list-unstyled">
                                <li class="next">
                                    <a href="project-details.html#" aria-label="Previous"><i class="icon-arrow-left"></i>Previous</a>
                                </li>
                                <li class="count"><a href="project-details.html#"></a></li>
                                <li class="count"><a href="project-details.html#"></a></li>
                                <li class="count"><a href="project-details.html#"></a></li>
                                <li class="count"><a href="project-details.html#"></a></li>
                                <li class="previous">
                                    <a href="project-details.html#" aria-label="Next">Next<i class="icon-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="{{ asset('main/images/resources/project-one-img-1.jpg') }}" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="{{ asset('main/images/resources/project-one-img-2.jpg') }}" alt="">
                                <div class="project-one__hover">
                                    <p class="project-one__tagline">Graphic</p>
                                    <h3 class="project-one__title"><a href="project-details.html">Fimlor Experience</a>
                                    </h3>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="{{ asset('main/images/resources/project-one-img-3.jpg') }}" alt="">
                                <div class="project-one__hover">
                                    <p class="project-one__tagline">Graphic</p>
                                    <h3 class="project-one__title"><a href="project-details.html">Fimlor Experience</a>
                                    </h3>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-2 text-end">
                            <div class="site-footer__bottom-inner">
                                <p class="site-footer__bottom-text"><a href="privacy-policy.html">Privacy Policy</a></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <a href="project-details.html#" data-target="html" class="scroll-to-target scroll-to-top"><i class="fa fa-angle-up"></i></a>
