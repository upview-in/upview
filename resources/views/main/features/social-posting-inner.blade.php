...
<body>
    <div class="boxed_wrapper ltr">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="inner-content paroller text-center">
                            <div class="title">
                                <h2 style="font-size: 50px;">Social Media Posting</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="connect-account" class="pr-section">
            <div class="inner-content paroller text-center">
                <div class="title">
                    <h2 style="font-size: 50px;">Connect all social media accounts</h2>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                    <div class="pr-nifo" data-aos="fade-right" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        ...
                        <p class="pr-docs">UPVIEW connects to all major social media platforms. Once you authorize UPVIEW, you can post to all your channels from a single interface.</p>
                    </div>
                </div>
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Integrate seamlessly.png') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                    <div class="pr-nifo" data-aos="fade-right" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        ...
                        <p class="pr-docs">Upload photos and videos to your social channels via UPVIEW.</p>
                    </div>
                </div>
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Multiple media formats.png') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                    <div class="pr-nifo" data-aos="fade-right" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        ...
                        <p class="pr-docs">Enter your caption and tag people to boost your content’s reach.</p>
                    </div>
                </div>
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Add key metadata.png') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
        <!-- connect account section end  -->

        <!-- Schedu;e Post section -->
        <section id="schedule-post" class="pr-section">
            <div class="inner-content paroller text-center">
                <div class="title">
                    <h2 style="font-size: 50px;">Schedule your posts</h2>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                ...
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Build a pipeline.png') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
        <!-- Schedu;e Post section end  -->

        <!-- hashtag section -->
        <section id="hashtag" class="pr-section">
            <div class="inner-content paroller text-center">
                <div class="title">
                    <h2 style="font-size: 50px;">Intelligent hashtag suggestions</h2>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                ...
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Use the right hash tags.png') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="multi-profile" class="pr-section">
            <div class="inner-content paroller text-center">
                <div class="title">
                    <h2 style="font-size: 50px;">Handle multiple profiles</h2>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                    <div class="pr-nifo" data-aos="fade-right" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        ...
                        <p class="pr-docs">Use the drop-down menu to select the brand and you’re ready to upload content to all connected accounts for that brand.</p>
                    </div>
                </div>
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Manage multiple brands.png') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="pr-row">
                <div class="pr-col">
                    <div class="pr-nifo" data-aos="fade-right" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        ...
                        <p class="pr-docs">For easy collaboration and accountability, UPVIEW maintains a record of team members who have uploaded each piece of content to your social channels.</p>
                    </div>
                </div>
                <div class="pr-col">
                    <div class="pr-img" data-aos="fade-left" ata-aos-offset="150" data-aos-easing="ease-in-sine">
                        <img src="{{ asset('main/assets/images/social-media-posting/Post History.png') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
        <!-- multi-profile section end  -->
