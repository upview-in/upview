...
<body>
    ...
    <section class="team-section position-relative">
        <img class="pattern" src="{{ asset('main/images/team/pattern.png') }}" alt="images-not_found" />
        <div class="container">
            <div class="row">
                <div class="col-12" data-aos="fade-up" data-aos-delay="100">
                    <div class="section-title process text-center pb-90">
                        <div class="icon">
                            <img src="{{ asset('main/images/icon/team.png') }}" alt="Icon_not_found" />
                        </div>
            ...
            <div class="row mb-n7">
                <div class="col-lg-3 col-sm-6 mb-7" data-aos="fade-up" data-aos-delay="300">
                    <div class="team-card">
                        <div class="thumb">
                            <img src="{{ asset('main/images/team/1.png') }}" alt="images_not_found" />
                            <img class="social-hover" src="{{ asset('main/images/team/team-hover.png') }}" alt="images_not_found" />
                            <ul class="team-social">
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-facebook"></i></em>
                                </li>
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-twitter"></i></em>
                                </li>
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-skype"></i></em>
                                </li>
                            </ul>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-sm-6 mb-7" data-aos="fade-up" data-aos-delay="600">
                    <div class="team-card">
                        <div class="thumb">
                            <img src="{{ asset('main/images/team/2.png') }}" alt="images_not_found" />
                            <img class="social-hover" src="{{ asset('main/images/team/team-hover.png') }}" alt="images_not_found" />
                            <ul class="team-social">
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-facebook"></em></a>
                                </li>
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-twitter"></em></a>
                                </li>
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-skype"></em></a>
                                </li>
                            </ul>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-sm-6 mb-7" data-aos="fade-up" data-aos-delay="900">
                    <div class="team-card">
                        <div class="thumb">
                            <img src="{{ asset('main/images/team/3.png') }}" alt="images_not_found" />
                            <img class="social-hover" src="{{ asset('main/images/team/team-hover.png') }}" alt="images_not_found" />
                            <ul class="team-social">
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-facebook"></em></a>
                ...
                <div class="col-lg-3 col-sm-6 mb-7" data-aos="fade-up" data-aos-delay="1200">
                    <div class="team-card">
                        <div class="thumb">
                            <img src="{{ asset('main/images/team/4.png') }}" alt="images_not_found" />
                            <img class="social-hover" src="{{ asset('main/images/team/team-hover.png') }}" alt="images_not_found" />
                            <ul class="team-social">
                                <li class="team-social-item">
                                    <a class="team-social-link" href="#"><em class="icofont-facebook"></em></a>
                        ...
                        <div class="news-letter pb-100">
                            <form id="mc-form" action="#" class="news-letter-form position-relative">
                                ...
                                <button class="btn btn-warning">
                                    Subscribe Now <em class="icofont-rounded-double-right"></em>
                                </button>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        <a class="footer-logo" href="index.html">
                                            <img src="{{ asset('main/images/logo/upview.png') }}" alt="logo_not_found" />
                                        </a>

                                        <ul class="adress">
                                            <li>
                                                <span class="icon"><em class="icofont-ui-call"></em></span>
                                                <a href="tel:0123456789">(+88) 454 632 897</a>
                                            </li>
                                            <li>
                                                <span class="icon"><em class="icofont-send-mail"></em></span>
                                                <a href="mailto:demo@gmail.com">demo@gmail.com</a>
                                            </li>
                                            <li>
                                                <span class="icon"><em class="icofont-google-map"></em></span> Chilton, Texas(TX), 76632
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Social Marketing
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>SEO Optimization
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Content Marketing
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                            ...
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Web Analytics
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Vision & Values
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Winning Awards
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Leadership</a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Sustainability</a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="#">
                                                    <em class="icofont-rounded-double-right"></em>Careers</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="footer-social">
                                            <li class="footer-social-item">
                                                <a class="footer-social-link" href="#"><em class="icofont-facebook"></em></a>
                                            </li>
                                            <li class="footer-social-item">
                                                <a class="footer-social-link" href="#"><em class="icofont-twitter"></em></a>
                                            </li>
                                            <li class="footer-social-item">
                                                <a class="footer-social-link" href="#"><em class="icofont-skype"></em></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
