    ...
    <div class="boxed_wrapper ltr">
        ...
        <header class="main-header header-style-three">
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="index.html"><img src="{{ asset('main/assets/images/resources/logo-white.svg') }}"
                    ...
                    <div class="col-xl-12">
                        <div class="service-deails-box">
                            ...
                            <div class="service-details-image-box">
                                <img src="{{ asset('main/assets/images/breadcrumb/Social_Media_Posting-Small.png') }}" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
