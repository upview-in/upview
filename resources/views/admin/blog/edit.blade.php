                ...
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        <div class="d-flex align-items-center w-100">
                            ...
                            <h5 class="mb-0 text-primary">{{ __('Edit Blog') }}</h5>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label font-weight-semibold required" for="poster">{{ __('Cover Image') }}</label>
                            ...
                            <div class="w-100 text-center mt-3">
                                <img id="showPosterPreview" alt="" width="50%" height="auto">
                            </div>
                        </div>
                    </div>
                </div>
