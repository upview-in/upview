        ...
        <div class="card-body p-5">
            <div class="card-title d-flex align-items-center">
                ...
                <div class="flex-shrink-1 pointer">
                    <a href="{{ route('admin.support.users.create') }}" class="d-flex align-items-center"><em class="bi bi-plus-circle me-1 font-22 text-primary"></em> <strong>Create</strong></a>
                </div>
            </div>
            <div class="row mt-3">
            ...
            <div class="table-responsive">
                <table class="table mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                <form class="ajax-form" method="POST" action="{{ route('admin.support.users.destroy', $user->id) }}">
                                    @method('delete')
                                    @csrf
                                    <a href="{{ route('admin.support.users.edit', $user->id) }}" class="btn btn-sm p-1">
                            ...
                            <td>{{ $user->username }}</td>
                            <td>
                                <form class="ajax-form" method="POST" action="{{ route('admin.support.users.update', $user->id) }}">
                                    @method('patch')
                                    @csrf
