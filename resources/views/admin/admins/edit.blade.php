    ...
    <div class="row g-3 m-0 p-0">
        <div class="col-md-12">
            <div class="card border-top border-0 border-4 border-success">
                <form class="ajax-form" method="POST" enctype="multipart/form-data" action="{{ route('admin.admins.update', $admin->id) }}">
                    @method('patch')
                    @csrf
                    <div class="card-body p-5">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-image ms-2 me-3" style="height: 80px; width: 80px">
                                <img src="{{ $admin->getFirstMediaUrl('avatars', 'thumb') }}" alt="" id="avatarImg" class="pointer">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4 col-sm-6 col-12">
                                ...
                                <input type="text" class="form-control" id="userName" name="name" placeholder="User Name" value="{{ old('name') ?? $admin->name }}" required>
                                @error('name')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="{{ old('username') ?? $admin->username }}" required>
                                @error('username')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4 col-sm-12 col-12">
                                ...
                                <select id="language" name="local_lang" class="select2">
                                    ...
                                    @endphp
                                    <option {{ $admin->local_lang !== $lang->code ?: "selected" }} value="{{ $lang->code }}">{{ $lang->name . ' (' . $lang->native_name . ')' }}</option>
                                    @endforeach
                                </select>
                                @error('local_lang')
                                <span class="invalid-feedback d-block" role="alert">
