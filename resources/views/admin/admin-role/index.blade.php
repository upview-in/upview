        ...
        <div class="card-body p-5">
            <div class="card-title d-flex align-items-center">
                <div class="d-flex align-items-center w-100">
                    ...
                    <h5 class="mb-0 text-primary">{{ __('Roles') }}</h5>
                </div>
                <div class="flex-shrink-1 pointer">
                    <a href="{{ route('admin.adminRoles.create') }}" class="d-flex align-items-center"><em class="bi bi-plus-circle me-1 font-22 text-primary"></em> <strong>Create</strong></a>
                </div>
            </div>
            <div class="row mt-3">
            ...
            <div class="table-responsive">
                <table class="table mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                <form class="ajax-form" method="POST" action="{{ route('admin.adminRoles.destroy', $adminRole->id) }}">
                                    @method('delete')
                                    @csrf
                                    <a href="{{ route('admin.adminRoles.edit', $adminRole->id) }}" class="btn btn-sm p-1">
                            ...
                            <td>
                                <form class="ajax-form" method="POST" action="{{ route('admin.adminRoles.update', $adminRole->id) }}">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" name="enabled" type="checkbox" value="true" onchange="$(this).closest('form').submit();" {{ ($adminRole->enabled ?? true)?'checked':'' }}>
                                    </div>
                                </form>
                            </td>
                ...
                <div class="mt-4">
                    {{ $adminRoles->withQueryString()->links() }}
                </div>
            </div>
        </div>
    </div>
