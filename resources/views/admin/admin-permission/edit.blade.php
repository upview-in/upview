...
<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.adminPermissions.index') }}">Permissions</a></li>
<li class="breadcrumb-item active" aria-current="page">{{ $adminPermission->name }}</li>
@endsection
            ...
            <div class="card-body p-5">
                ...
                <div class="row g-3">
                    <div class="col-md-6 col-sm-6 col-12">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ old('name') ?? $adminPermission->name }}" required>
                        @error('name')
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        ...
                        <input type="text" class="form-control" id="slug" name="slug" placeholder="slug" value="{{ old('slug') ?? $adminPermission->slug }}" required>
                        @error('slug')
                        <span class="invalid-feedback d-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
