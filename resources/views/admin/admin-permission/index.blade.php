        ...
        <div class="card-body p-5">
            <div class="card-title d-flex align-items-center">
                ...
                <div class="flex-shrink-1 pointer">
                    <a href="{{ route('admin.adminPermissions.create') }}" class="d-flex align-items-center"><em class="bi bi-plus-circle me-1 font-22 text-primary"></em> <strong>Create</strong></a>
                </div>
            </div>
            <div class="row mt-3">
