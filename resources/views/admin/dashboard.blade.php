                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-auto">
                            <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class='bi bi-dots-horizontal-rounded font-22 text-option'></i>
                            </a>
                    ...
                    <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
                        <span class="border px-1 rounded cursor-pointer"><em class="bi bi-circle me-1 text-info"></em>Downloads</span>
                        <span class="border px-1 rounded cursor-pointer"><em class="bi bi-circle me-1 text-danger"></em>Earnings</span>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-0 row-group text-center border-top">
                    <div class="col">
                        <div class="p-3">
                            ...
                            <small class="mb-0">Today's Sales <span> <em class="bi bi-up-arrow-alt align-middle"></em> 2.43%</span></small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3">
                            <h4 class="mb-0">$856</h4>
                            <small class="mb-0">This Week Sales <span> <em class="bi bi-up-arrow-alt align-middle"></em> 12.65%</span></small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3">
                            <h4 class="mb-0">$2400</h4>
                            <small class="mb-0">This Month Sales <span> <em class="bi bi-up-arrow-alt align-middle"></em> 5.62%</span></small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3">
                            <h4 class="mb-0">$4,562</h4>
                            <small class="mb-0">This Year Sales <span> <em class="bi bi-up-arrow-alt align-middle"></em> 12.62%</span></small>
                        </div>
                    </div>
                </div>
            </div>
