...
<body class="color-scheme-neue">
	...
	<div class="bg-img" style="width: 100%; height: 100%; position: fixed; background: #0c0a13 url({{ asset('images/space-bg.jpg') }}) no-repeat center center; background-size: 100% auto; "></div>
	<!-- First screen -->
	<div class="splash">
