...
class FacebookController extends Controller
{
    ...
    public static function getFacebookPagesInsights(GetFBPageInsights $request)
    {
        ...
        } else dd($fbUser['data']); //else return response()->json(collect(['err_msg' =>'Something went wrong while getting your Facebook Pages. Please try to refresh/relinking your account to fix. If still not fixed, try contacting our support. Sorry for any inconvinence caused.']), 405);
    }
